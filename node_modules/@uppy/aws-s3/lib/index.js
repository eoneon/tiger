...
export default class AwsS3 extends UploaderPlugin {
  constructor(uppy, _opts) {
    ...
    this.setQueueRequestSocketToken(_classPrivateFieldLooseBase(this, _requests)[_requests].wrapPromiseFunction(_classPrivateFieldLooseBase(this, _requestSocketToken)[_requestSocketToken], {
      priority: -1
    }));
  }
  [_Symbol$for]() {
  ...
  connectToServerSocket(file) {
    return _classPrivateFieldLooseBase(this, _uploader)[_uploader].connectToServerSocket(file);
  }
